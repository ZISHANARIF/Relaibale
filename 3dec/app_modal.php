...
<!-- WhatsApp Popup -->
<div class="modal fade" id="whatsappEnquiry" tabindex="-1" aria-labelledby="sendWhatsappLabel" aria-hidden="true">
      ...
      <div class="modal-body pt-3">
        ...
        <form method="post" target="_blank" id="whatsapp_form">
          ...
          <div class="d-grid">
            ...
            <button type="submit" name="whatsapp_submit" class="main-btn">
...
<div class="modal fade" id="callEnquiry" tabindex="-1" aria-labelledby="sendreqcallLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered enquiry-dialog whatsapp-dialog">
    ...
    <div class="modal-content enquiry-card">
      ...
      <div class="modal-body pt-3">
        <div id="responseMessageCall"></div>
        <form id="request_call" method="post">
          ...
          <div class="text-center mb-3">
            ...
            <div class=" popupheading catName" id="productName">Product Name Here</div>
            <img src="<?= NO_IMG_URL ?>" title="<?= COMPANY ?>" alt="<?= COMPANY ?>" class="img-fluid rounded product-img mb-2 respImg">
          ...
          <div class="d-grid">
            ...
            <button type="submit" name="call_back" title="Submit" class="main-btn">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body modal-body-custom">
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="leadsuresubheading catName">Rotary Barrel Pump</div>
            <div class="product-display-areamodal">
              <div class="product-image-containermodal">
                <!-- Placeholder for Pump Image -->
                <img src="<?= NO_IMG_URL ?>" alt="<?= COMPANY ?>" class="product-imgmodal respImg" title="<?= COMPANY ?>">
              </div>
          ...
          <div class="col-lg-5">
            <div class="enquiry-form-wrappermodal">
              ...
              <form id="product_pop_form1" method="post">
                ...
                <div class="d-grid">
                  <button type="submit" class="main-btn" name="submit_cat_popup">
                    <span class="me-2 align-middle">
                      <!-- Envelope icon (Bootstrap Icons SVG inline, no extra lib needed) -->
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
                        <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z" />
